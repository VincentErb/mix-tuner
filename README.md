...
- Detects pitch in real time using MPM algorithm
- Supports standard and alternate tunings per instrument
- Free tuner mode for any note

## Install

Download the latest APK from [Releases](https://github.com/VincentErb/mix-tuner/releases/latest) and sideload it on your Android device.
